...
try {
    // Actualizar la planilla con el estado, observaciones y quién la cerró
    $stmt = $conn->prepare(
        "UPDATE check_ins 
...
if ($status === 'Rechazado') {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        throw new Exception('La planilla no pudo ser actualizada. Es posible que ya haya sido procesada por otro usuario.');
    }
